# UNDERDOG-MASS-ENTER-CHROME-EXTENSION
...
3. Open the downloaded .zip file, click into the folder that says `Underdog-Mass-Enter-Chrome-Extension`, then again into the `zip` folder. Select the .zip file and extract it somewhere on your computer.
